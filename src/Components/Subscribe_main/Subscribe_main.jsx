  ...
  return (
    <div className={styles.subscribe_wrapper}>
      <div className={styles.subscribe_content}>
        ...
        Subscribe
          <span className={styles.subscribe_flex}> <FaArrowRightLong /></span>
        </button>
        <img className={styles.subscribe_overlay_image} src={'https://azim.hostlin.com/Travic/assets/images/shape/shape-17.png'} alt="" />
      </div>

      <div className={styles.subscribe_parashoot_image_wrapper}> 
          <img src={'https://azim.hostlin.com/Travic/assets/images/background/subscribe-bg-2.png'} alt="subscribe_parashoot" />
      </div>
    </div>
  );
};
